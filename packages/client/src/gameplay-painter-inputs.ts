...
import type { generateSurvivalDecorations, CollisionMap, Direction, PlayerState, SpaceDefinition, WildlifeSpecies, MiningNodeClass, GeneratedSurvivalDecoration, MapLandmarkInstance } from '@orchard/sim';
...
export interface GameplayPainterInputs {
  ...
  readonly projectedLight: (light: PointLight, terrainSampleY?: number) => PointLight;
  ...
  readonly clientProcessorRuntime: (snapshot: OverworldView, placeable: WorldPlaceable) => { object: import("@orchard/sim").ObjectContentDefinition; processor: import("@orchard/sim").ObjectProcessorComponent; definitions: import("@orchard/sim").ProcessContentDefinition[]; adapter: "smelting" | "campfire_cooking" | "press" | "fermentation" | "barrel"; } | null;
  ...
  readonly wildlifeProfile: (snapshot: OverworldView, npcId: bigint) => { readonly species: WildlifeSpecies; readonly variant: number; } | null;
  readonly npcTargetDimensions: (species: WildlifeSpecies | null) => { readonly halfWidth: number; readonly height: number; };
