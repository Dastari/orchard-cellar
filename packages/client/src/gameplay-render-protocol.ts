import { installPainterProducerProfile } from './painter-producer-profile.js';
...
export interface ProtocolOptions {
  ...
  readonly profilePainter?: boolean;
...
export async function captureGameplayProtocol(metrics: RenderMetrics, game: ProtocolGameplay, options: ProtocolOptions) {
  ...
  let painterProfile: ReturnType<typeof installPainterProducerProfile> | null = null;
  ...
  try {
    ...
    if (options.profilePainter) painterProfile = installPainterProducerProfile();
    ...
    result = {
      ...
      painterProfile: painterProfile?.report() ?? null,
