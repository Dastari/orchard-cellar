...
import {hearthLobbyPortalApproachClear,TILE_SIZE_FIXED,type CollisionMap} from '@orchard/sim';
...
function fixture(){
  ...
  const portal={fromSpace:0,fromTileX:10,fromTileY:10,toSpace:65532};
