...
export const PATCHES: Readonly<Record<PatchName, Instrument>> = {
  ...
  pad: {
    ...
    amp: { attack: 0.9, decay: 1.6, sustain: 0.86, release: 1.8 },
    filter: { type: 'lowpass', cutoffHz: 900, q: 0.6, envOctaves: 0.4, envDecay: 1.4, keyTrack: 0.3, velocityOctaves: 0.8 },
    velocity: 0.4,
    gain: 0.5,
    pan: 0,
  ...
  bass: {
    ...
    amp: { attack: 0.02, decay: 0.7, sustain: 0.72, release: 0.35 },
    filter: { type: 'lowpass', cutoffHz: 650, q: 0.7, envOctaves: 0.8, envDecay: 0.1, keyTrack: 0.2, velocityOctaves: 0.6 },
    velocity: 0.5,
    gain: 0.6,
    pan: 0,
