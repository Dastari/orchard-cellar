...
describe('pixel display controls', () => {
  ...
  it('reduces landscape phones to 1x without reducing landscape tablets', () => {
    expect(fittedUiScale(2, 844, 390)).toBe(1);
    expect(fittedUiScale(3, 932, 430)).toBe(1);
    expect(fittedUiScale(2, 1024, 768)).toBe(2);
    expect(fittedUiScale(3, 1366, 1024)).toBe(3);
  });
});
