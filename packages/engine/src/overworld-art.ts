import { frame, stoneFrameSource, drawAnchored, drawRogueEnemyVisual, type AvatarPalette } from './world-anchored-draw.js';
export type { AvatarPalette } from './world-anchored-draw.js';
...
export function drawOverworldMerchant(
  ...
  const vertical = facing === 'up' || facing === 'upLeft' || facing === 'upRight'
    ...
    : facing === 'down' || facing === 'downLeft' || facing === 'downRight'
      ? 'down'
      : 'right';
  const fishermanAnimation = npcKind === 'fisherman_fin' && !moving
...
export function drawOverworldRogueEnemy(
  ...
  drawRogueEnemyVisual(context, visual, x, y, cameraX, cameraY, zoom, hitFlash);
}
