...
export interface StudioLiveRows {
  readonly placeables: readonly { readonly id: bigint; readonly spaceId: number; readonly kind: string; readonly definitionId?: string; readonly ownerIdentity?: string; readonly state?: AdminJsonObject; readonly tileX?: number; readonly tileY?: number; readonly elevation?: number; readonly facing?: string; readonly open?: boolean; readonly lit?: boolean; readonly smeltStartTick?: bigint; readonly processStartTick?: bigint; readonly barrelSealedTick?: bigint; readonly cookStartTick?: bigint }[];
  readonly chests?: readonly { readonly id: bigint; readonly spaceId: number; readonly definitionId?: string; readonly ownerIdentity?: string; readonly state?: AdminJsonObject; readonly tileX: number; readonly tileY: number; readonly elevation?: number; readonly open?: boolean; readonly facing?: string }[];
  readonly combatTargets?: readonly { readonly id: bigint; readonly spaceId: number; readonly kind?: string; readonly definitionId?: string; readonly tileX: number; readonly tileY: number; readonly elevation?: number; readonly healthCenti?: number; readonly maxHealthCenti?: number }[];
  readonly resources?: readonly { readonly definitionId?: string; readonly id: bigint; readonly spaceId: number; readonly kind: string; readonly tileX: number; readonly tileY: number; readonly elevation?: number; readonly health?: number; readonly depleted?: boolean; readonly growthStage?: number; readonly miningClass?: string; readonly richness?: number; readonly maximumRichness?: number }[];
  ...
  readonly npcs: readonly { readonly id: bigint; readonly spaceId: number; readonly kind: string; readonly definitionId?: string; readonly displayName?: string; readonly x?: number; readonly y?: number; readonly homeX?: number; readonly homeY?: number; readonly riderIdentity?: string; readonly facing?: string; readonly moving?: boolean; readonly wanderDirection?: string; readonly health?: number; readonly species?: string; readonly variant?: number }[];
