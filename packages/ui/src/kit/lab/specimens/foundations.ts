...
export const foundationsSpecimen: UiLabSpecimen = {
  ...
  build(ui, props, mock) {
    return ui.frame({ style: 'parchment_plain', header: { title: 'Orchard UI Kit' }, layout: { width: 'grow', height: 'grow', overflow: 'scroll-y', gap: 8 }, children: [
      ...
      ui.text(props['longLabels'] ? 'Long labels wrap within their arranged box. '.repeat(8) : '5x7 controls and ordinary headings. Integer scale. Clipped by default.'),
      ...
      ui.text('Orchard Almanac', { role: 'special-heading' }),
      ui.text('Explicit 8x12 exception: a decorative almanac heading.'),
      ui.separator(),
