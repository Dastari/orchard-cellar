...
export const UI_LAB_MIGRATION_SURFACES = [
  { id: 'build-palette', title: 'Homestead Build Palette', category: 'world', description: 'Construction selection, refunds and upgrades.', specimenSize: { width: 640, height: 640 }, closable: false },
  { id: 'delve-confirmation', title: 'Start Delve', category: 'world', description: 'Begin a solo run or cancel.', specimenSize: { width: 760, height: 470 }, closable: false },
  { id: 'delve-rewards', title: 'Delve Rewards', category: 'world', description: 'Required boon choices and cellar trader offers.', specimenSize: { width: 1080, height: 650 }, closable: false },
  { id: 'statistics', title: 'Lifetime Statistics', category: 'progression', description: 'Records chapter of the player book: categories and exact totals', specimenSize: {width:920,height:640}, closable:true },
  ...
  { id: 'online-players', title: 'Online Players', category: 'world', description: 'Scrollable presence roster', specimenSize: { width: 600, height: 500 }, closable: true },
  { id: 'feedback-overlays', title: 'Nameplates & Feedback', category: 'world', description: 'World labels, tooltips, and toast stack', specimenSize: { width: 800, height: 1120 }, closable: false },
  { id: 'touch-controls', title: 'Touch Actions', category: 'world', description: 'Joystick, interaction, sprint, and menu actions', specimenSize: { width: 760, height: 560 }, closable: false },
  ...
  { id: 'barrel', title: 'Barrel Storage', category: 'storage', description: 'Four-by-two storage and seal state', specimenSize: { width: 500, height: 440 }, closable: true },
  ...
  { id: 'press', title: 'Fruit Press', category: 'storage', description: 'Fruit, must, pomace, and pressing progress', specimenSize: { width: 900, height: 420 }, closable: true },
  { id: 'fermentation', title: 'Fermentation Cask', category: 'storage', description: 'Must, bottles, and fermentation progress', specimenSize: { width: 900, height: 420 }, closable: true },
  { id: 'character', title: 'Character', category: 'progression', description: 'Character chapter: paper doll, wardrobe, attributes, vitals and professions', specimenSize: { width: 980, height: 500 }, closable: true },
  { id: 'skills', title: 'Skill Tree', category: 'progression', description: 'Skills chapter: tracks, selected skill and the authored tree', specimenSize: { width: 980, height: 500 }, closable: true },
  { id: 'quest-log', title: 'Quest Log', category: 'progression', description: 'Quests chapter: active and completed quests, objectives and actions', specimenSize: { width: 800, height: 410 }, closable: true },
  { id: 'help-book', title: 'Help Book', category: 'progression', description: 'Help book: chapter tabs, topic list, markdown pages and links', specimenSize: { width: 840, height: 440 }, closable: true },
...
export const UI_LAB_COVERAGE: readonly UiLabCoverageEntry[] = [
  ...
  { id: 'migration-diagnostics', label: 'Diagnostics and terrain layer inspection', group: 'migration', interactive: true },
