...
export const UI_LAB_MIGRATION_SURFACES = [
  ...
  { id: 'statistics', title: 'Lifetime Statistics', category: 'progression', description: 'Lifetime records with exact totals and pagination', specimenSize: {width:920,height:640}, closable:true },
