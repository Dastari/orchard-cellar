...
import { bootstrapContentRows, buildContentRegistry, BACKPACK_SLOT_COUNT, CHEST_STORAGE_CAPACITY, CHEST_STORAGE_COLUMNS, CHEST_STORAGE_ROWS, EQUIPMENT_SLOTS, EQUIPMENT_SLOT_OFFSET, HOTBAR_SLOT_COUNT } from '@orchard/sim';
  ...
  it('keeps authored crafting draw and pointer nodes on the composed grid after resize and reopen', () => {
    ...
    for (const width of [360, 480, 600, 480]) {
      ui.update({
        ...
        inventory: [{ slot: 39, itemKind: 'wood', quantity: 1 }], hasBackpack: true, contentRegistry, knownRecipeIds: ['planks'],
        audioVolumes: { master: 1, music: 1, sfx: 1 }, canAdministerWorld: false,
        dateLabel: 'SPRING 1', timeLabel: '06:00', timeFraction: 0,
        raining: false, weatherMode: 'auto', prompt: null, toast: null,
      });
