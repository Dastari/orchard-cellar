...
describe('bootstrap authored object behaviour parity', () => {
  it('contains the exact reviewed object graph migration batch', () => {
    expect(objects.map(({ id }) => id)).toEqual([
      'object:anvil', 'object:barn', 'object:barrel', 'object:camp_cooking_fire', 'object:campfire',
      'object:chest', 'object:cooking_fire', 'object:coop', 'object:fence', 'object:fence_gate',
