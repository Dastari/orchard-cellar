...
export const PLACEABLE_HANDLER_REGISTRATIONS = Object.freeze([
  ...
  },
  {
    ...
    handler: (event, view) => view.target !== undefined
      && 'entityType' in view.target
      && view.target.definitionId === 'object:chest'
      && booleanState(view, 'hasContents') === false
      ? effectsResult([{ pickupAsItem: 'chest' }])
      : effectsResult([{
