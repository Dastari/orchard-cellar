...
export const ITEM_DEFINITIONS = {
  ...
  fiber: defineItem('fiber', 'Fiber', 99, ['item.resource', 'material.fiber']),
  ...
  grape: defineItem('grape', 'Grapes', 32, ['item.crop', 'item.food', 'crop.fruit']),
  ...
  backpack: defineItem('backpack', 'Backpack', 1, ['item.equipment', 'container.backpack']),
