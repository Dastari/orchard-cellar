// FROZEN FIXTURE: the schema-1 world chunk codec exactly as deployed before the
// authority extension (origin/main c2e85788, packages/sim/src/world-chunk.ts).
// Tests decode new blobs with it to prove deployed decoders ignore authority data.
