...
const catalogPath = resolve(rootPath, 'packages/engine/src/cute-fantasy-actor-catalog.generated.ts');
...
function professionDefinition(
  ...
  return {
    ...
    kind: 'npc',
    family: 'Professions',
    source: `references/art/kenmi/cute-fantasy/core/NPCs (Premade)/${sourceName}.png`,
    cell: [64, 64],
    crop: [16, 8, 32, 40],
    rows,
    companions,
...
const sheets: SheetDefinition[] = [
  ...
  ]),
  {
    ...
    // Fin's rod, line, bobber and splash use the complete authored 64x64
    // action cell. The standard profession crop only contains the body and
    // visibly severs all four fishing effects at its 32x40 boundary.
    crop: [0, 0, 64, 64],
    // Keep the same ground contact as the standard [16, 8, 32, 40] crop.
    anchor: [32, 47],
  },
  ...
  ...Array.from({ length: 4 }, (_, index): SheetDefinition => ({
    ...
    source: `references/art/kenmi/cute-fantasy/desert/NPC/Desert_Person_${index + 1}.png`,
    cell: [32, 32], rows: baseTen,
  })),
  {
    name: 'npc_cf_pharaoh', label: 'Pharaoh', kind: 'npc', family: 'Desert',
    source: 'references/art/kenmi/cute-fantasy/desert/NPC/Pharaoh.png', cell: [32, 32], rows: baseTen,
  },
  ...Array.from({ length: 3 }, (_, index): SheetDefinition => ({
    ...
    kind: 'npc', family: 'Desert',
    source: `references/art/kenmi/cute-fantasy/desert/NPC/Traders/Desert_Trader_${index + 1}.png`,
    cell: [32, 32], rows: [{ name: 'idle', row: 0 }],
  })),
  {
    name: 'npc_cf_witch', label: 'Witch', kind: 'npc', family: 'Holiday',
    source: 'references/art/kenmi/cute-fantasy/halloween/Witch/Witch.png', cell: [32, 32],
    rows: animationRows([
  ...
  },
  {
    ...
    source: 'references/art/kenmi/cute-fantasy/christmas/Characters/Santa_Claus.png', cell: [32, 32], rows: baseTen,
  },
  {
    name: 'npc_cf_santa_helper', label: 'Santa Helper', kind: 'npc', family: 'Holiday',
    source: 'references/art/kenmi/cute-fantasy/christmas/Characters/Santa_Claus_Helper.png', cell: [32, 32], rows: baseTen,
  },
  {
    name: 'npc_cf_reindeer', label: 'Reindeer', kind: 'npc', family: 'Holiday',
    source: 'references/art/kenmi/cute-fantasy/christmas/Characters/Reindeer.png', cell: [64, 64],
...
sheets.push(
  faction('actor_cf_knight_archer', 'Knight Archer', 'Knights', 'references/art/kenmi/cute-fantasy/characters/Knights/Archer.png', 48, combatThirteen, ['effect_cf_bow_stages', 'projectile_cf_crossbow_bolt']),
  faction('actor_cf_knight_spearman', 'Knight Spearman', 'Knights', 'references/art/kenmi/cute-fantasy/characters/Knights/Spearman.png', 48),
  faction('actor_cf_knight_swordman', 'Knight Swordman', 'Knights', 'references/art/kenmi/cute-fantasy/characters/Knights/Swordman.png', 48),
  faction('actor_cf_knight_templar', 'Knight Templar', 'Knights', 'references/art/kenmi/cute-fantasy/characters/Knights/Templar.png', 48),
  faction('actor_cf_angel_01', 'Angel 1', 'Angels', 'references/art/kenmi/cute-fantasy/characters/Angels/Angel_1.png', 64),
  faction('actor_cf_angel_02', 'Angel 2', 'Angels', 'references/art/kenmi/cute-fantasy/characters/Angels/Angel_2.png', 64),
  faction('actor_cf_goblin_archer', 'Goblin Archer', 'Goblins', 'references/art/kenmi/cute-fantasy/characters/Goblins/Goblin_Archer.png', 48, combatThirteen, ['effect_cf_bow_stages', 'projectile_cf_crossbow_bolt']),
  faction('actor_cf_goblin_maceman', 'Goblin Maceman', 'Goblins', 'references/art/kenmi/cute-fantasy/characters/Goblins/Goblin_Maceman.png', 32),
  faction('actor_cf_goblin_spearman', 'Goblin Spearman', 'Goblins', 'references/art/kenmi/cute-fantasy/characters/Goblins/Goblin_Spearman.png', 48),
  faction('actor_cf_goblin_thief', 'Goblin Thief', 'Goblins', 'references/art/kenmi/cute-fantasy/characters/Goblins/Goblin_Thief.png', 32),
  faction('actor_cf_orc_archer', 'Orc Archer', 'Orcs', 'references/art/kenmi/cute-fantasy/characters/Orcs/Orc_Archer.png', 48, combatThirteen, ['effect_cf_bow_stages', 'projectile_cf_crossbow_bolt']),
  faction('actor_cf_orc_chief', 'Orc Chief', 'Orcs', 'references/art/kenmi/cute-fantasy/characters/Orcs/Orc_Chief.png', 64, animationRows([
    'idle_down', 'idle_right', 'idle_up', 'walk_down', 'walk_right', 'walk_up', 'special', 'defeat',
  ])),
  faction('actor_cf_orc_grunt', 'Orc Grunt', 'Orcs', 'references/art/kenmi/cute-fantasy/characters/Orcs/Orc_Grunt.png', 64, animationRows([
    'idle_down', 'idle_right', 'idle_up', 'walk_down', 'walk_right', 'walk_up', 'special', 'defeat',
  ])),
  faction('actor_cf_orc_peon', 'Orc Peon', 'Orcs', 'references/art/kenmi/cute-fantasy/characters/Orcs/Orc_Peon.png', 64, animationRows([
    'idle_down', 'idle_right', 'idle_up', 'walk_down', 'walk_right', 'walk_up', 'special', 'defeat',
  ])),
);
...
function enemy(
  ...
  // Native combat sheets contain substantial transparent padding below the
  // ground contact. Anchor grounded creatures to their authored feet/shadow;
  // the flying skull deliberately retains its hover above the logical plane.
  const contactY = name.includes('flying_skull') ? cellSize - 1
    : cellSize === 48 ? 31 : cellSize === 64 ? 41
      : cellSize === 32 ? (name.includes('slime_medium') ? 21 : 24)
        : name.includes('snail') ? 12 : 14;
  return { name, label, kind: 'enemy', family, source, cell: [cellSize, cellSize],
    anchor: [cellSize / 2, contactY], rows, companions };
}

sheets.push(
  enemy('enemy_cf_skeleton', 'Skeleton', 'Skeletons', 'references/art/kenmi/cute-fantasy/core/Enemies/Skeleton/Skeleton.png', 32, baseTen),
  enemy('enemy_cf_skeleton_bowman', 'Skeleton Bowman', 'Skeletons', 'references/art/kenmi/cute-fantasy/core/Enemies/Skeleton/Skeleton_Bowman/Merged/Skeleton_Bowman.png', 32, combatThirteen, ['weapon_cf_skeleton_bow', 'projectile_cf_crossbow_bolt']),
  enemy('enemy_cf_skeleton_mage', 'Skeleton Mage', 'Skeletons', 'references/art/kenmi/cute-fantasy/core/Enemies/Skeleton/Skeleton_Mage.png', 32, casterThirteen, ['projectile_cf_skeleton_mage']),
  enemy('enemy_cf_skeleton_swordman', 'Skeleton Swordman', 'Skeletons', 'references/art/kenmi/cute-fantasy/core/Enemies/Skeleton/Skeleton_Swordman.png', 32, animationRows([
    'idle_down', 'idle_right', 'idle_up', 'walk_down', 'walk_right', 'walk_up', 'defeat',
    'attack_down', 'attack_right', 'attack_up', 'special_down', 'special_right', 'special_up',
    'hurt_down', 'hurt_right', 'hurt_up',
  ])),
  enemy('enemy_cf_desert_atgier_01', 'Desert Atgier 1', 'Desert Hostiles', 'references/art/kenmi/cute-fantasy/desert/enemies/Desert_Warrior_Atgier_1.png', 64, combatThirteen),
  enemy('enemy_cf_desert_atgier_02', 'Desert Atgier 2', 'Desert Hostiles', 'references/art/kenmi/cute-fantasy/desert/enemies/Desert_Warrior_Atgier_2.png', 64, combatThirteen),
  enemy('enemy_cf_desert_bow_01', 'Desert Bowman 1', 'Desert Hostiles', 'references/art/kenmi/cute-fantasy/desert/enemies/Desert_Warrior_Bow_1.png', 64, combatThirteen, ['effect_cf_bow_stages', 'projectile_cf_crossbow_bolt']),
  enemy('enemy_cf_desert_bow_02', 'Desert Bowman 2', 'Desert Hostiles', 'references/art/kenmi/cute-fantasy/desert/enemies/Desert_Warrior_Bow_2.png', 64, combatThirteen, ['effect_cf_bow_stages', 'projectile_cf_crossbow_bolt']),
  enemy('enemy_cf_mummy', 'Mummy', 'Desert Hostiles', 'references/art/kenmi/cute-fantasy/desert/enemies/Mummy.png', 32, combatThirteen),
  enemy('enemy_cf_cowling_01', 'Cowling 1', 'Volcano', 'references/art/kenmi/cute-fantasy/volcano/Enemies/Cowling_1.png', 48, combatThirteen),
  enemy('enemy_cf_cowling_02', 'Cowling 2', 'Volcano', 'references/art/kenmi/cute-fantasy/volcano/Enemies/Cowling_2.png', 48, combatThirteen),
  enemy('enemy_cf_cowling_mage_01', 'Cowling Mage 1', 'Volcano', 'references/art/kenmi/cute-fantasy/volcano/Enemies/Cowling_Mage_1.png', 48, casterThirteen),
  enemy('enemy_cf_cowling_mage_02', 'Cowling Mage 2', 'Volcano', 'references/art/kenmi/cute-fantasy/volcano/Enemies/Cowling_Mage_2.png', 48, casterThirteen),
  enemy('enemy_cf_flying_skull', 'Flying Skull', 'Volcano', 'references/art/kenmi/cute-fantasy/volcano/Enemies/Flying_Skull.png', 32,
    animationRows(['idle', 'move', 'attack', 'defeat'])),
  enemy('enemy_cf_bombschroom', 'Bombschroom', 'Shroomlands', 'references/art/kenmi/cute-fantasy/core/Enemies/Bombschroom/Bombschroom.png', 16, genericRows(21), ['effect_cf_bombschroom_gas']),
  enemy('enemy_cf_shroomling_blue', 'Blue Shroomling', 'Shroomlands', 'references/art/kenmi/cute-fantasy/shroomlands/Shroomlings/Blue_Shroomling.png', 16, genericRows(26)),
  enemy('enemy_cf_shroomling_green', 'Green Shroomling', 'Shroomlands', 'references/art/kenmi/cute-fantasy/shroomlands/Shroomlings/Green_Shroomling.png', 16, genericRows(26)),
  enemy('enemy_cf_shroomling_purple', 'Purple Shroomling', 'Shroomlands', 'references/art/kenmi/cute-fantasy/shroomlands/Shroomlings/Purple_Shroomling.png', 16, genericRows(26)),
  enemy('enemy_cf_shroomling_yellow', 'Yellow Shroomling', 'Shroomlands', 'references/art/kenmi/cute-fantasy/shroomlands/Shroomlings/Yellow_Shroomling.png', 16, genericRows(26)),
  enemy('enemy_cf_shroomling_alive_big', 'Alive Shroomling (Big)', 'Shroomlands', 'references/art/kenmi/cute-fantasy/shroomlands/Shroomlings/Big_Alive_Shroomling.png', 16, genericRows(3)),
  enemy('enemy_cf_shroomling_alive_small', 'Alive Shroomling (Small)', 'Shroomlands', 'references/art/kenmi/cute-fantasy/shroomlands/Shroomlings/Small_Alive_Shroomling.png', 16, genericRows(3)),
);
...
for (const size of ['big', 'medium', 'small'] as const) for (const color of ['blue', 'green', 'pink', 'red', 'yellow'] as const) {
  ...
  sheets.push(enemy(
    ...
    'Slimes',
    `references/art/kenmi/cute-fantasy/core/Enemies/Slime/Slime_${title(size)}/Slime_${title(size)}_${title(color)}.png`,
    cellSize,
    [
...
for (let index = 0; index < 4; index += 1) sheets.push(enemy(
  ...
  `Small Snail ${index + 1}`,
  'Shroomlands',
  `references/art/kenmi/cute-fantasy/shroomlands/Snails/Snail_Small_${index + 1}.png`,
  16,
  [{ name: 'idle', row: 0 }],
));
...
sheets.push(
  effect('projectile_cf_skeleton_mage', 'Skeleton Mage Projectile', 'Projectiles', 'references/art/kenmi/cute-fantasy/core/Other/Skeleton_Mage_Projectile.png', 16, [{ name: 'travel', row: 0 }]),
  effect('projectile_cf_crossbow_bolt', 'Crossbow Bolt', 'Projectiles', 'references/art/kenmi/cute-fantasy/dungeons/Objects/Crossbow_Bolt.png', 16, [{ name: 'base', row: 0 }]),
  effect('effect_cf_bow_stages', 'Bow Charge Stages', 'Combat Equipment', 'references/art/kenmi/cute-fantasy/core/Other/Bow_Stages.png', 16, [{ name: 'charge', row: 0 }]),
  effect('weapon_cf_skeleton_bow', 'Skeleton Bow Layers', 'Combat Equipment', 'references/art/kenmi/cute-fantasy/core/Enemies/Skeleton/Skeleton_Bowman/Separated/Skeleton_Bowman_Bow.png', 32, genericRows(9)),
  effect('effect_cf_mounted_crossbow', 'Mounted Crossbow', 'Combat Equipment', 'references/art/kenmi/cute-fantasy/dungeons/Objects/Mounted_Crossbow_anim.png', 16, [{ name: 'fire', row: 0 }]),
  effect('effect_cf_bombschroom_gas', 'Toxic Gas Cloud', 'VFX', 'references/art/kenmi/cute-fantasy/core/Enemies/Bombschroom/Toxic_Gas_Cloud_VFX.png', 16, genericRows(2)),
  effect('effect_cf_witch_bat', 'Witch Bat', 'Witch Companions', 'references/art/kenmi/cute-fantasy/halloween/Witch/Bat.png', 16, [{ name: 'fly', row: 0 }]),
  effect('effect_cf_witch_broom', 'Witch Broom', 'Witch Companions', 'references/art/kenmi/cute-fantasy/halloween/Witch/Broom.png', 32, genericRows(2)),
  effect('effect_cf_witch_cauldron', 'Witch Cauldron', 'Witch Companions', 'references/art/kenmi/cute-fantasy/halloween/Witch/Witch_Cauldron_Anim.png', 32, [{ name: 'bubble', row: 0 }]),
);
...
async function writeSheet(definition: SheetDefinition): Promise<ActorCatalogEntry> {
  ...
  const asset: AssetSource = {
    ...
    size,
    anchor: definition.anchor ?? [Math.floor(size[0] / 2), size[1] - 1],
    frames,
...
for (let index = 0; index < 4; index += 1) catalog.push({
  ...
  sourcePath: `references/art/kenmi/cute-fantasy/shroomlands/Snails/Snail_${index + 1}.png`,
  companions: [],
});
