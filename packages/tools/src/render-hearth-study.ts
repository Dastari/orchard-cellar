...
import {spaceDefinitionFor,planHearthArchitecture,cellFlagsWhere} from '/packages/sim/src/index.ts';
...
try {
 ...
 for(const rank of [0,1,2,3]) {
   ...
   const terrain=rank===3?{...base,spaceId:30002,residenceEnvelopeBlocked:undefined,blocked:cellFlagsWhere(1024,i=>!(i%32>=3&&i%32<=12&&Math.floor(i/32)>=17&&Math.floor(i/32)<=26))}:base;
