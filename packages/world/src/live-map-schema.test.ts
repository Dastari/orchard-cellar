...
describe('revisioned live map authority', () => {
  ...
  it('caches suppression indexes and decoration overlays with the compiled revision', () => {
    ...
    expect(runtime).toContain("ground: suppressedGeneratedDecorationObstacleKeys(document, generatedSuppressions, 'ground')");
    expect(runtime).toContain("water: suppressedGeneratedDecorationObstacleKeys(document, generatedSuppressions, 'water')");
