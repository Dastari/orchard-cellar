...
| Vitals | Health, Mana and Vigour already exist, normally 100 each; 100 centi-units = 1 displayed unit. Regeneration at baseline: 0.2 / 1 / 12 per second. Authority is **20 Hz**. | Generic instant vital restoration, exact periodic restores and consumable admission. Mana needs a useful approved sink, not a new stat. |
