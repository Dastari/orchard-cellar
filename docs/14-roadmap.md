...
- [ ] Doc59 A-16 — CPU dimming and hit-flash variants — IN PROGRESS: codex, 2026-09-08. Apply the settled opaque ≤2 / translucent ≤8 gate after checked cliff correction8ffdef5c. Mechanically extract owned main/art drawing first, then remove world filters through bounded CPU variant pages and submit those same pages to WebGL. Preserve immutable artwork, exact normal rendering, no world readback and cleanup. Full evidence under output/perf-59-20260908/P5/A16/; A-14 follows. No deployment.
