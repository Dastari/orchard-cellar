...
- [ ] Doc59 A-17 — Complete-run fallback accounting — IN PROGRESS: codex,2026-09-08. After a93914dc, fresh-session WebGL-on protocols on cliff/carried-light and pond, recording every encountered reason and actual GPU/Canvas submissions through preparation, warm-up, sample and restoration. A-14 remains OPEN; A-19 Canvas release request follows, no deployment.
