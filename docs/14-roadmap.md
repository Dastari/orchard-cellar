...
- [ ] Doc 59 P8 — Experimental WebGL2 world pass — IN PROGRESS: codex, 2026-09-06
  - Ground-plane submission follow-up — IN PROGRESS: codex, 2026-09-07. Isolated guard-subset probe identifies the missing raw-field ground composite; implement and qualify it after the current minimap checkpoint, with Canvas and unqualified-path fallbacks preserved.
