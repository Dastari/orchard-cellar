...
- [ ] Doc59 A-14 — Integer texel sampling and producer counters — IN PROGRESS: codex,2026-09-08. After checked A-16, qualify integer-ratio draws exactly using texelFetch/integer arithmetic and noninteger nearest draws under the one-texel source-index rule. Record per-producer noninteger world draws on A1, preserve exact Canvas output and every unqualified guard. Artifacts output/perf-59-20260908/P8/A14/. A-15 follows; no deployment.
