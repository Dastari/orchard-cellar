...
- [ ] Doc59 A-15 — Cutaway edge-band qualification — IN PROGRESS: codex,2026-09-08. Re-evaluate the preserved bounded clip-raster implementation against the amended4-step edge/2-step outside/1% above-one/HUD-exact gate, then verify resources, context loss and real route fallback evidence. A-14 sampler remains OPEN. No deployment.
