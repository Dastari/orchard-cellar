...
- [ ] Doc59 cliff-stall regression — IN PROGRESS: codex, 2026-09-08. Owner prioritizes the severe slowdown approaching cliff faces. Add larger normal keyboard approaches/departures with actor-follow camera, worst-frame/stage/counter evidence and boundary crossings; retain A1 general timings as regression evidence. Output-only capture work under output/perf-59-20260908/P4/cliff-stall/. Compare before A11/A12 and current Canvas; no deployment.
