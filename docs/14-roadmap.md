...
- [ ] Doc59 A-13 — Identity present pass — IN PROGRESS: codex, 2026-09-08. Verify the existing exact-integer shortcut against an output-only forced two-copy reference; record finalWorldComposite and all stages/counters on cliff and pond routes. Artifacts output/perf-59-20260908/P1/A13/. No deployment.
