...
- [ ] Doc 59 A-7 / P6b — Mechanical painter-producer extraction, producer attribution and retained commands — IN PROGRESS: codex, 2026-09-07
  - Remaining entity draw callbacks — IN PROGRESS: codex, 2026-09-07. Retain player/resource receiver callbacks and replace repeated carried-object/mount predicates without changing sampling order. Base16dfdf43 full631/3622 check green; evidence P6/remaining-entity-callbacks.
  - Nested entity receiver callbacks — COMPLETE: codex, 2026-09-07. Merchant and five placeable callbacks retain identity/current state across600 frames. Full631/3622 check green,555 sorted tuples exact,ten Canvas boards/36 originals exact,18 headless minute reviews complete. Latest diagnostic6.8/7.6/16.3→7.3/7.4/16.1ms p95 is no_pond and no speedup claim. Player/resource/terrain callbacks and full A-7 exit stay open. Artifacts P6/receiver-callbacks.
