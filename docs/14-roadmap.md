...
- [x] Doc59 cliff-stall regression — DONE: codex, 2026-09-08. Exact caster-cohort retention and static-mask sample reuse reduce larger-route Dynamic merge maxima22.9–25.1→6.9–7.4ms; all nine after runs have zero≥50ms long tasks. Full638 files/3642 tests;10 exact Canvas boards;18 minute reviews;36 original PNGs unchanged. A1 merge p950.9ms; whole10.9ms residual and remaining drawing spikes recorded. Complete owner-reported halt remains unreproduced. Doc59§9 / output/perf-59-20260908/P4/cliff-stall/. A-16 next; no deployment.
- [x] Doc59 A-16 — DONE: codex,2026-09-08. CPU dim/hit/placement variants remove all world filters; opaque≤2/translucent≤4/HUD0,240 GPU cases pass with≤1 additional step. Bounded memory,600 warm frames allocate0 surfaces/ImageData, full disposal. Full639 files/3650 tests,10 exact boards,18 minute reviews,36 original PNGs unchanged. Both route tables in doc59§9/output/perf-59-20260908/P5/A16/. Dynamic merge p950.9ms; whole11.4ms and gameplay clip fallback remain explicit. A-14 next; no deployment.
- [x] Doc59 A-14/A-14a — DONE: codex,2026-09-08. Original per-producer counters retained; near-half-pixel probe defect resolved by owner amendment. Prototype and production each pass120/576/720 plus288 cases, integer exact/noninteger≤1texel/coverage0. Production672c079f retains all guards; full651files/3691tests,10 exact boards,A15/A16 and six A17 empty fallback sets pass. OriginalP8/A14 evidence immutable; follow-upP8/A14a. No deployment.
- [x] Doc59 A-15 — DONE: codex,2026-09-08. Bounded clip masks pass72/72 amended edge cases (band3/outside2/HUD0),600 warm frames allocate0 canvases/ImageData, actual context loss restores, disposal0. Full643 files/3664 tests;10 exact Canvas boards,18 movement reviews (all9 GPU requests stay WebGL),both route tables. Dynamic merge p950.9ms,whole11.6ms;moving-cliff max29ms/no50ms tasks. A-17 followed; the historical A-14 OPEN status is resolved by A-14a above; no deployment in that step.
- [x] Doc59 A-17 — FALLBACK CONDITION PASS / HARDWARE GPU UNAVAILABLE: codex,2026-09-08. Six fresh-session route/mode sets remain empty on672c079f with only WebGL submissions. Original and new22-stage/counter values remain SwiftShader diagnostics, not hardware FAIL. Radeon vfio-pci binding, no /dev/dri and absent amdgpu recorded inP8/A14a/D. Hardware timing owner to run; Developer/off, no deployment.
- [x] Doc59 A-19 — CANVAS RELEASE DEPLOYED: codex,2026-09-08. Developer-only persisted WebGL control, Canvas1×default and visible fallback; full644files/3670tests,10 exact boards,16 panel fixtures,18 movement reviews and both route stage/counter tables. Dynamic merge p950.900003433ms; whole/cold-cliff residual explicit. Archive client-0.6.0-fd0cb7e6.tar, build/static/reconnect/integrity gates pass; request and exact rollback/publication commands under output/perf-59-20260908/release/. Owner Go received; all439 public files and same-account reconnect pass. Startup502 automatically rolled back, then bounded readiness retry passed; Studio unchanged. Evidence release/deployment/.
...
- [ ] Doc 59 A-7 / P6b — Mechanical painter-producer extraction, producer attribution and retained commands — IN PROGRESS: codex, 2026-09-07
  - Remaining entity draw callbacks — COMPLETE: codex, 2026-09-07. Player/rock/ore callbacks and carried-object predicates retain identity/current state; mount lookup preserves first-match order. Full633 files/3627 tests and isolated build pass. Ten Canvas boards,544 sorted tuples,323 regenerated assets and36 originals exact;18 headless minute reviews complete. Diagnostic6.6/7.6/16.6→6.3/7.8/16.2ms p95 remains no_pond. Full A-7/release gates remain open; evidence P6/remaining-entity-callbacks.
  - Nested entity receiver callbacks — COMPLETE: codex, 2026-09-07. Merchant and five placeable callbacks retain identity/current state across600 frames. Full631/3622 check green,555 sorted tuples exact,ten Canvas boards/36 originals exact,18 headless minute reviews complete. Latest diagnostic6.8/7.6/16.3→7.3/7.4/16.1ms p95 is no_pond and no speedup claim. Player/resource callbacks are completed in the subsequent checkpoint; terrain callbacks and full A-7 exit stay open. Artifacts P6/receiver-callbacks.
...
- [ ] Doc 59 A-1 / P0 follow-up — Repeatable workload, effective-quality request attribution and sky-step capture — IN PROGRESS: codex, 2026-09-07
  - Follow owner amendments in doc 59 §8; subsequent order is P6b painter producers, exact Canvas fixes, GPU qualification and allocation attribution. Historical conditional deployment instruction is superseded by A-19: prepare the Canvas release request, then await release-specific owner Go; no deployment in this run.
...
- [ ] Doc 59 P3 — Shadowless page variants and runtime filtering removal — IN PROGRESS: codex, 2026-09-06
  - Committed `ed18ed63`:100 omit pages, runtime filtered-frame machinery deleted, atomic page cohorts; historical344-asset comparison and Canvas goldens pass. Authenticated after-stage captures now work through the ordinary test account (see current follow-ups); final pond-qualified/shared active review remains open.
- [ ] Doc 59 P4 — Static/moving coverage and constant-time receivers — IN PROGRESS: codex, 2026-09-06
  - Committed `22f8dcea`: static/moving coverage and retained raster/ImageData uploads;600-frame allocation witnesses and exact goldens pass. The owner withdrew merged-field constant-time sampling in A-3. Exact spatial candidate indexing now ships; final qualified scene measurement remains open.

- [ ] Doc 59 P5 — Tint pool and cap-layer consolidation — IN PROGRESS: codex, 2026-09-06
  - Committed `96c9b6c0`: bounded exact-RGB tint pages, reset/disposal and exact goldens. A-4 accepts exact RGB and withdraws quantization. A-6 keeps per-run cap order, with exact run reuse and plane sampling implemented. A-5 post-lighting transparency reconstruction/world filter removal remains OPEN; no zero tint-build claim for continuously changing RGB.
...
- [ ] Doc 59 P7 — Frame pacing and HUD caching — IN PROGRESS: codex, 2026-09-06
  - Committed `e0a92b1d`/`556999ba`: persisted30Hz cap preserving fixed updates and three ordered HUD caches,45 exact comparisons,247→80 stationary drawImage calls/frame. Full check600 suites/3,509 tests. Authenticated stage/counter follow-ups and minimap reuse are recorded below; final qualified scene/shared review stays open. iPad cap default stays off and battery/thermal evidence is owner to run.
- [ ] Doc 59 P8 — Experimental WebGL2 world pass — IN PROGRESS: codex, 2026-09-06
  - Terrain cutaway clip follow-up — OPEN: codex, 2026-09-07. Three coverage representations fail A-8 (max4/3/4; HUD exact). Prototype removed; checked7fff5781 runtime and visible unsupported-clip Canvas fallback retained. Evidence P8/cutaway-clips; continue independent painter work under docs/15 §9.
  - Ground-plane submission follow-up — COMPLETE: codex, 2026-09-07. Raw-field ground composite implemented after d4134843 minimap checkpoint; nine production-engine boards meet A-8, and world/terrain/pond HUD pixels are exact. Receiver/ground/multiply paths qualify, source-downsampling/filter fallbacks remain. Checkpoint full check630 files /3,618 tests green; Canvas capture has zero long tasks/surfaces, but no pond. Eighteen60-second headless reviews and Video footer confirm Canvas fallback on unsupported terrain cutaway clipping. This subset is complete; P8 overall remains in progress. Evidence under P8/ground-plane.
  - Prerequisite docs `485edbbc`, exact Canvas seam `1b0ed15e`, then guarded WebGL integration with persisted off-default toggle, frame-boundary fallback and resource disposal. Canvas-copy present wins pixel parity; three GPU lighting approximations fail and unverified paths visibly fall back. Original integration check passed610 suites/3560 tests; current callback checkpoint passes633 files/3627 tests. Isolated builds and Canvas goldens pass. Refreshed candidate0685bc82 is packaged with verified rollback and private reconnect; full acceptance remains OPEN and release HOLD. See doc59 ledger and output/perf-59-20260907/release/README.md.
