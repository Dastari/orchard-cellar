...
A separate table would require another public subscription and cleanup lifecycle; reusing respawnAtTick would entangle mining and tree readiness. The appended field keeps indexed resource access and migration simple, at the cost of a small field on every resource. Existing maturity rules remain authoritative. Configured fruit trees lose fruit on felling, eliminating pick/fell duplication and giving maintenance a distinct purpose.
